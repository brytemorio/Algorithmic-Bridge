...
public class QnodeCoinABI extends Contract {
    ...
    public static final Event SENDSTOCONTRACTADDRESS_EVENT = new Event("SendsToContractAddress", 
    ...
    @Deprecated
    protected QnodeCoinABI(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected QnodeCoinABI(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected QnodeCoinABI(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected QnodeCoinABI(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public List<SendsToContractAddressEventResponse> getSendsToContractAddressEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(SENDSTOCONTRACTADDRESS_EVENT, transactionReceipt);
        ArrayList<SendsToContractAddressEventResponse> responses = new ArrayList<SendsToContractAddressEventResponse>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
            SendsToContractAddressEventResponse typedResponse = new SendsToContractAddressEventResponse();
            typedResponse.log = eventValues.getLog();
            typedResponse._sender = (String) eventValues.getNonIndexedValues().get(0).getValue();
            typedResponse._contractAddr = (String) eventValues.getNonIndexedValues().get(1).getValue();
    ...
    public Flowable<SendsToContractAddressEventResponse> sendsToContractAddressEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(new Function<Log, SendsToContractAddressEventResponse>() {
            @Override
            public SendsToContractAddressEventResponse apply(Log log) {
                Contract.EventValuesWithLog eventValues = extractEventParametersWithLog(SENDSTOCONTRACTADDRESS_EVENT, log);
                SendsToContractAddressEventResponse typedResponse = new SendsToContractAddressEventResponse();
                typedResponse.log = log;
                typedResponse._sender = (String) eventValues.getNonIndexedValues().get(0).getValue();
                typedResponse._contractAddr = (String) eventValues.getNonIndexedValues().get(1).getValue();
    ...
    public Flowable<SendsToContractAddressEventResponse> sendsToContractAddressEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(SENDSTOCONTRACTADDRESS_EVENT));
        return sendsToContractAddressEventFlowable(filter);
    }
    ...
    @Deprecated
    public static QnodeCoinABI load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new QnodeCoinABI(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static QnodeCoinABI load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new QnodeCoinABI(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static QnodeCoinABI load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new QnodeCoinABI(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static QnodeCoinABI load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public static class SendsToContractAddressEventResponse extends BaseEventResponse {
        public String _sender;

        public String _contractAddr;
